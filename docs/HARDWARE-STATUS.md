...
| Wi-Fi | `configured` | Runtime (2026-08-10, captura limpia): SIN `wlan0`, sin bus mmc/sdio, módulos `ath10k_core/pci/snoc` + `wcn36xx` presentes pero NO cargados. El transporte WCN3990 de laurel sigue sin resolver en el kernel 6.1 probado; no se debe afirmar SDIO o SNOC solo por el nombre del driver. |
