...
| Wi-Fi | `configured` | Runtime (2026-08-10, captura limpia): SIN `wlan0`, sin bus mmc/sdio, módulos `ath10k_core/pci/snoc` + `wcn36xx` presentes pero NO cargados. El transporte WCN3990 de laurel sigue sin resolver en el kernel 6.1 probado; no se debe afirmar SDIO o SNOC solo por el nombre del driver. Artefacto CI listo para prueba física (2026-08-14): workflow 18 run `31819773343` en main `213d421e`, `boot-linux61-wcn3990-v2.img` con DTB final v2 validado 24/24 gates; `physical_status=boot-untested`. Prueba física pendiente de autorización. |
